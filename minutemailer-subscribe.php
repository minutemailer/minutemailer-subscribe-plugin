...
*/ ?>
	...
	function widget($args, $instance) {
        ...
        // https://subscribe.minutemailer.com/
        // https://subscribe.test.minutemailer.com/

		// Display form ?>
		<form class="minutemailer-signup" action="https://subscribe.minutemailer.com/<?php echo $list_id; ?>" method="post">
			<p>
